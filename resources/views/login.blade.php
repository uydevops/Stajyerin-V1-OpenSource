...
<head>
    ...
    <meta charset="utf-8" />
    <title>Stajyerin.com | Giriş Yap</title>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="auth-content card-body p-5 h-100 text-white">
                                                <div class="w-100">
                                                    ...
                                                    <form action="{{route('admin.login.control')}}" method="POST">
                                                        @csrf
                                                        <div class="mb-3">
                                                            <label for="usernameInput" class="form-label">Email</label>
                                                            <input type="text" name="email" class="form-control" id="usernameInput" placeholder="Enter your username" required>
                                                        </div>
                                                        <div class="mb-3">
